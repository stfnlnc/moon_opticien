...
@section('meta')
    <meta property="og:description"
        content="Moon Opticien Lunetier est un magasin d’optique indépendant, installé à Bizanos (proche de Pau) et à Denguin (proche d'Artix). Nous sommes trois opticiens diplômés, passionnés par notre métier et déterminés
                à vous offrir le meilleur service possible." />
    <meta name="description"
        content="Moon Opticien Lunetier est un magasin d’optique indépendant, installé à Bizanos et à Denguin. Nous sommes trois opticiens diplômés, passionnés par notre métier et déterminés
                à vous offrir le meilleur service possible.">
...
@section('content')
    <section class="relative w--100 h--100">
        <img loading="lazy" class="img img-header img-mobile w--100 h--100"
            src="{{ asset('/images/layers/2e68def2b88b.webp') }}" alt="Magasin de lunettes à Bizanos et Denguin">
        <div class="absolute t--0 l--0 w--100 h--100" style="background: linear-gradient(rgba(0,0,0,0), rgba(0,0,0,0.6))">
        </div>
        <div class="container absolute flex pos-hor-center b--0 col align--start justify--end gap--10">
    ...
    <section class="flex container__full-width c--primary-light bg--secondary-dark col align--center">
        <div class="container grid text-center grid--4 grid--2-mobile grid-gap--5 pt--10 pb--10">
    ...
    <section class="flex container__full-width c--secondary-dark bg--secondary-color-4 col align--center">
        <div class="container">
            <div
                class="flex border--top border--secondary-color-3 c--secondary-color-3 pt--4 pb--4 row align--center justify--start gap--2 hide-mobile">
            ...
            <div class="grid grid--2 grid-gap--14 grid--1-mobile grid-gap--8-mobile pt--10 pb--20">
                ...
                <p class="text--m">
                    Moon Opticien Lunetier est un magasin d’optique et audition indépendant, installé à Bizanos et à
                    Denguin. Nous
                    sommes trois opticiens diplômés, passionnés par notre métier et déterminés
    ...
    <section class="flex container__full-width c--secondary-dark bg--primary-light col align--center">
        <div class="container">
            <div
                class="flex hide-mobile border--top border--secondary-color-3 c--secondary-color-3 pt--4 pb--4 row align--center justify--start gap--2">
                <x-icon.dot-small class="icon__dot-small icon--secondary-color-3"></x-icon.dot-small>
            ...
            <div class="grid grid--2 grid-gap--14 grid--1-mobile grid-gap--8-mobile pt--10 pb--20">
                ...
                <div class="flex col align--start gap--10">
                    <p class="text--m">
                        ...
                        notre expertise pour vous guider dans le choix de vos lunettes, lentilles de contact et solutions
                        auditives. <br>
                    </p>
    ...
    <section class="flex container__full-width c--secondary-dark bg--secondary-color-4 col align--center">
        <div class="container">
            ...
            <div class="grid grid--2 grid-gap--14 grid--1-mobile grid-gap--8-mobile pt--10 pb--20">
                <h2>Des conseils personnalisés dans nos magasins.</h2>
                <div class="flex col align--start gap--10">
                    <p class="text--m">
                        Notre objectif est de vous offrir un service de qualité, personnalisé et à la hauteur de vos
            ...
            <div class="flex row align--end justify--start gap--16">
                <img loading="lazy" class="img img__shop hide-mobile"
                    src="{{ asset('/images/layers/6a98c021ca22c8980f02f19c289b96de.webp') }}"
                    alt="Examen de la vue et prescription de lunettes">
                <div class="grid grid--2 grid-gap--10 grid-gap--6-mobile">
                    <div class="flex col gap--3 reveal-0">
                        <img loading="lazy" class="icon--large" src="{{ asset('/images/icon/large/icon-discuss.svg') }}"
                            alt="Conseil">
                    ...
                    <div class="flex col gap--3 reveal-1">
                        <img loading="lazy" class="icon--large" src="{{ asset('/images/icon/large/icon-rule.svg') }}"
                            alt="Ajustement">
                        <div class="flex col gap--1">
                            <p class="text--l">Ajuster</p>
                            <p class="text--s">
                                Nous ajustons vos lunettes, lentilles de contact et solutions auditives pour un
                                confort optimal.
                            </p>
                        </div>
                    </div>
                    <div class="flex col gap--3 reveal-2">
                        <img loading="lazy" class="icon--large" src="{{ asset('/images/icon/large/icon-recycle.svg') }}"
                            alt="Recyclage">
                        <div class="flex col gap--1">
                            <p class="text--l">Recycler</p>
                            <p class="text--s">
                                Nous offrons un service de collecte de lunettes afin de donner une seconde vie à vos
                                anciennes montures.
                            </p>
                        </div>
                    </div>
                    <div class="flex col gap--3 reveal-3">
                        <img loading="lazy" class="icon--large"
                            src="{{ asset('/images/icon/large/icon-favorite.svg') }}" alt="Personnalisation">
                        <div class="flex col gap--1">
    ...
    <section class="flex container__full-width c--secondary-dark bg--secondary-color-2 col align--center">
        <div class="container flex pt--10 pb--10 col align--center gap--8">
            <div class="grid text-center grid--2 grid-gap--10 w--70 w-100-mobile">
                <div class="flex col align--center gap--2">
                    <x-icon.dot-medium class="icon__dot-medium icon--secondary-dark"></x-icon.dot-medium>
                    <p class="text--l">Tiers payant</p>
                    <p class="text--s c--secondary-color-3">N'avancez plus les frais de vos lunettes, on s'occupe de tout.
                        *</p>
                </div>
                <div class="flex col align--center gap--2">
                    <x-icon.dot-medium class="icon__dot-medium icon--secondary-dark"></x-icon.dot-medium>
                    <p class="text--l">100% santé</p>
                    <p class="text--s c--secondary-color-3">Bénéficiez de lunettes de qualité sans aucun reste à charge. *
                    </p>
                </div>
            </div>
    ...
    <section class="flex container__full-width c--primary-light bg--secondary-dark col align--center">
        <div class="container">
            <div
                class="flex hide-mobile border--top border--secondary-color-2 c--secondary-color-2 pt--4 pb--4 row align--center justify--start gap--2">
    ...
    <section class="flex container__full-width c--secondary-dark bg--secondary-color-4 col align--center">
        <div class="container">
            ...
            <div class="grid grid--2 grid-gap--14 grid--1-mobile grid-gap--8-mobile pt--10 pb--20">
                ...
                <div class="flex col align--start gap--10">
                    <p class="text--m">
                        Nous mettons un point d'honneur à vous offrir un choix diversifié et de qualité supérieure, allant
                        des classiques intemporels aux dernières tendances. Que vous recherchiez des lunettes de vue
            ...
            <div class="flex row justify--end w--100">
                <div class="grid grid--4 grid-gap--2 grid--2-mobile">
                    <div class="flex col align--start justify--start gap--3 block__glasses reveal-0">
                        ...
                        <a href="{{ route('glasses') }}#eyeglasses" class="btn btn--secondary-light">Découvrir</a>
                    </div>
                    <div class="flex col align--start justify--start gap--3 block__glasses reveal-1">
                        ...
                        <a href="{{ route('glasses') }}#sunglasses" class="btn btn--secondary-light">Découvrir</a>
                    </div>
                    <div class="flex col align--start justify--start gap--3 block__glasses reveal-2">
                        ...
                        <a href="{{ route('glasses') }}#sportglasses" class="btn btn--secondary-light">Découvrir</a>
                    </div>
                    <div class="flex col align--start justify--start gap--3 block__glasses reveal-3">
                        ...
                        <a href="{{ route('glasses') }}#childglasses" class="btn btn--secondary-light">Découvrir</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section
        style="background-image: linear-gradient(rgba(94,117,103,0.98), rgba(94,117,103,0.98)), url('{{ asset('/images/layers/a7e72401fb434c9febabc88ff04202aeL.webp') }}'); background-size: cover; background-position: 100% 30%;"
        class="relative flex container__full-width c--primary-light bg--secondary-color-3 col align--center">
        <div class="container">
            <div
                class="flex hide-mobile border--top border--secondary-color-2 c--secondary-color-2 pt--4 pb--4 row align--center justify--start gap--2">
                <x-icon.dot-small class="icon__dot-small icon--secondary-color-2"></x-icon.dot-small>
            ...
            <div class="grid grid--2 grid-gap--14 grid--1-mobile grid-gap--8-mobile pt--10 pb--20">
                ...
                <div class="flex col align--start gap--10">
                    <p class="text--m">
                        Pour une commande rapide et pratique, remplissez notre formulaire et récupérez vos lentilles
    ...
    <section class="flex container__full-width c--secondary-dark bg--secondary-color-2 col align--center">
        <div class="container">
            <div
                class="flex hide-mobile border--top border--secondary-color-3 c--secondary-color-3 pt--4 pb--4 row align--center justify--start gap--2">
                <x-icon.dot-small class="icon__dot-small icon--secondary-color-3"></x-icon.dot-small>
                <p class="text--s">Audition</p>
            </div>
            <div class="grid grid--2 grid-gap--14 grid--1-mobile grid-gap--8-mobile pt--10 pb--20">
                <h2>Votre nouvel espace dédié aux solutions auditives</h2>
                <div class="flex col align--start gap--10">
                    <p class="text--m">
                        Nous vous accompagnons dans chaque étape de votre santé auditive grâce à un service complet et sur
                        mesure. Notre audioprothésiste vous conseille et veille à votre confort au quotidien. Avec des
                        solutions 100 % santé et un accompagnement personnalisé, profitez d’une écoute
                        attentive et d’un suivi de qualité, chaque mercredi dans notre magasin de Denguin.<br>
                    </p>
                    <div class="flex col gap--2">
                        <a href="{{ route('contact') }}" class="btn btn--main-light">Je prends rendez-vous</a>
                        <a href="{{ route('audition') }}" class="btn btn--secondary-light">En savoir
                            plus</a>
                    </div>
                </div>
            </div>
            <div class="flex row align--start justify--space-between gap--4 w--100">
                <img loading="lazy" class="img img-left w-100-mobile w--30 reveal-0"
                    src="{{ asset('/images/layers/audition-3.png') }}" alt="Magasin d'optique centre ville de Bizanos">
                <img loading="lazy" class="img img-center hide-mobile w--30 reveal-1"
                    src="{{ asset('/images/layers/audition-6.png') }}"
                    alt="Conseil, ajustement et réparation de lunettes aux portes de Pau">
                <img loading="lazy" class="img img-right hide-mobile w--30 reveal-2"
                    src="{{ asset('/images/layers/audition-2.png') }}" alt="Lunettes de vue, solaire ou de sport">
            </div>
        </div>
    </section>
