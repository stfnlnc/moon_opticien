...
@section('content')
    ...
    <section class="container__full-width c--secondary-dark bg--secondary-color-4 flex col align--center">
        <div class="container">
            <div
                    class="border--top border--secondary-color-3 c--secondary-color-3 pt--4 pb--4 flex row align--center justify--start gap--2 hide-mobile">
            ...
            <div class="grid grid--2 grid-gap--14 grid--1-mobile grid-gap--8-mobile pt--10 pb--20">
                ...
                <p class="text--m">
                    Moon Opticien Lunetier est un magasin d’optique et audition indépendant, installé à Bizanos et à Denguin. Nous
            ...
            <div class="grid grid--2 grid-gap--14 grid--1-mobile grid-gap--8-mobile pt--10 pb--20">
                ...
                <div class="flex col align--start gap--10">
                    <p class="text--m">
                        ...
                        notre expertise pour vous guider dans le choix de vos lunettes, lentilles de contact et solutions auditives. <br>
                    </p>
        ...
        <div class="container pt--10 pb--10 flex col align--center gap--8">
            <div class="grid grid--2 grid-gap--10 text-center w--70 w-100-mobile">
                <div class="flex col align--center gap--2">
                    ...
                    <p class="text--s c--secondary-color-3">N'avancez plus les frais de vos lunettes, on s'occupe de tout. *</p>
                </div>
                <div class="flex col align--center gap--2">
                    <x-icon.dot-medium class="icon__dot-medium icon--secondary-dark"></x-icon.dot-medium>
                    <p class="text--l">100% santé</p>
                    <p class="text--s c--secondary-color-3">Bénéficiez de lunettes de qualité sans aucun reste à charge. *</p>
                </div>
            </div>
    ...
    <section class="container__full-width c--primary-light bg--secondary-dark flex col align--center">
        <div class="container">
            <div
                    class="hide-mobile border--top border--secondary-color-2 c--secondary-color-2 pt--4 pb--4 flex row align--center justify--start gap--2">
    ...
    <section
            ...
            class="relative container__full-width c--primary-light bg--secondary-color-3 flex col align--center">
        <div class="container">
            <div
                    class="hide-mobile border--top border--secondary-color-2 c--secondary-color-2 pt--4 pb--4 flex row align--center justify--start gap--2">
                <x-icon.dot-small class="icon__dot-small icon--secondary-color-2"></x-icon.dot-small>
    ...
    <section class="container__full-width c--secondary-dark bg--secondary-color-2 flex col align--center">
        <div class="container">
            ...
            <div class="grid grid--2 grid-gap--14 grid--1-mobile grid-gap--8-mobile pt--10 pb--20">
                ...
                <div class="flex col align--start gap--10">
                    <p class="text--m">
                        Nous vous accompagnons dans chaque étape de votre santé auditive grâce à un service complet et sur mesure. Notre audioprothésiste vous conseille et veille à votre confort au quotidien. Avec des solutions 100 % santé et un accompagnement personnalisé, profitez d’une écoute
